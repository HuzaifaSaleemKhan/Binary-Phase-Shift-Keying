...
x = input('Enter Digital Input Information in Binary = ');  
N = length(x);
Tb = 0.0001;   %Data rate = 1MHz i.e., bit period (second)
disp('Binary Input Information at Transmitter end: ');
disp(x);
...
figure('Name','BPSK Modulation and Demodulation for Final Lab'); %Title for figure
subplot(3,1,1);
...
disp('Demodulated Binary Information at Receiver end: ');
disp(demod);
